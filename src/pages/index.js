  ...
  <PageWrapper>
    <Section>
      <TextGrid>
        ...
        <p>
          Hello! My name is Marvin Kubiak, I focus on good{' '}
       ...
       {/* <p> I like the number <span className="highlight">1990</span> and I'm passionate with lots of
          design-related topics such as <span className="highlight">typography</span>, <span className="highlight">3D-rendering</span>,{' '}
          <span className="highlight">color theory</span> and other small things, that make the world a bit easier. </p> */}
